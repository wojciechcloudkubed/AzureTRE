locals {
  ws_unique_identifier_suffix    = var.parent_ws_unique_identifier_suffix
  svc_unique_identifier_suffix   = var.unique_identifier_suffix == ""? substr(var.tre_resource_id, -6, -1): var.unique_identifier_suffix
