...
resource "azurerm_private_endpoint" "import_approved_pe" {
  name                = "pe-sa-import-approved-blob-${var.unique_identifier_suffix}"
  location            = var.location
  resource_group_name = var.ws_resource_group_name
  ...
  private_service_connection {
    name                           = "psc-sa-import-approved-${var.unique_identifier_suffix}"
...
resource "azurerm_private_endpoint" "export_internal_pe" {
  name                = "pe-sa-export-int-blob-${var.unique_identifier_suffix}"
  location            = var.location
  resource_group_name = var.ws_resource_group_name
  subnet_id           = var.services_subnet_id
  tags                = var.tre_workspace_tags
  ...
  private_service_connection {
    name                           = "psc-sa-export-int-${var.unique_identifier_suffix}"
...
resource "azurerm_private_endpoint" "export_inprogress_pe" {
  name                = "pe-sa-export-ip-blob-${var.unique_identifier_suffix}"
  location            = var.location
  resource_group_name = var.ws_resource_group_name
  subnet_id           = var.services_subnet_id
  tags                = var.tre_workspace_tags
  ...
  private_service_connection {
    name                           = "psc-sa-export-ip-${var.unique_identifier_suffix}"
...
resource "azurerm_private_endpoint" "export_rejected_pe" {
  name                = "pe-sa-export-rej-blob-${var.unique_identifier_suffix}"
  location            = var.location
  resource_group_name = var.ws_resource_group_name
  subnet_id           = var.services_subnet_id
  tags                = var.tre_workspace_tags
  ...
  private_service_connection {
    name                           = "psc-sa-export-rej-${var.unique_identifier_suffix}"
...
resource "azurerm_private_endpoint" "export_blocked_pe" {
  name                = "pe-sa-export-blocked-blob-${var.unique_identifier_suffix}"
  location            = var.location
  resource_group_name = var.ws_resource_group_name
  subnet_id           = var.services_subnet_id
  tags                = var.tre_workspace_tags
  ...
  private_service_connection {
    name                           = "psc-sa-export-blocked-${var.unique_identifier_suffix}"
