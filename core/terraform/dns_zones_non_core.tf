...
resource "azurerm_private_dns_zone_virtual_network_link" "mysql" {
  ...
  private_dns_zone_name = azurerm_private_dns_zone.non_core["privatelink.mysql.database.usgovcloudapi.net"].name
  name                  = azurerm_private_dns_zone.non_core["privatelink.mysql.database.usgovcloudapi.net"].name
